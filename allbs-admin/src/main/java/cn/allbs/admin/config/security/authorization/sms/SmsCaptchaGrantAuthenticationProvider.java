...
import static cn.allbs.admin.config.constants.SecurityConstant.OAUTH_PARAMETER_NAME_PHONE;
import static cn.allbs.admin.config.constants.SecurityConstant.OAUTH_PARAMETER_NAME_SMS_CAPTCHA;
...
public class SmsCaptchaGrantAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication getAuthenticatedUser(SmsCaptchaGrantAuthenticationToken authenticationToken) {
        ...
        String phone = (String) additionalParameters.get(OAUTH_PARAMETER_NAME_PHONE);
        String smsCaptcha = (String) additionalParameters.get(OAUTH_PARAMETER_NAME_SMS_CAPTCHA);
